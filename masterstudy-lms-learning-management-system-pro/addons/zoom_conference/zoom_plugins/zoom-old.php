...
class STM_LMS_Zoom_Conference
{
    ...
    public static function add_lesson_type_admin( $fields )
    {
        ...
        $fields[ 'stm_lesson_settings' ][ 'section_lesson_settings' ][ 'fields' ][ 'join_before_host' ] = array(
            'type' => 'checkbox',
            'label' => esc_html__( 'Join before host', 'masterstudy-lms-learning-management-system-pro' ),
        );

        $fields[ 'stm_lesson_settings' ][ 'section_lesson_settings' ][ 'fields' ][ 'option_host_video' ] = array(
            'type' => 'checkbox',
            'label' => esc_html__( 'Host join start', 'masterstudy-lms-learning-management-system-pro' ),
        );

        $fields[ 'stm_lesson_settings' ][ 'section_lesson_settings' ][ 'fields' ][ 'option_participants_video' ] = array(
            'type' => 'checkbox',
            'label' => esc_html__( 'Start After Participants', 'masterstudy-lms-learning-management-system-pro' ),
        );
        ...
        $fields[ 'stm_lesson_settings' ][ 'section_lesson_settings' ][ 'fields' ][ 'option_enforce_login' ] = array(
            'type' => 'checkbox',
            'label' => esc_html__( 'Enforce Login', 'masterstudy-lms-learning-management-system-pro' ),
        );
        ...
        <div v-if="fields['type'] === 'zoom_conference'">
            ...
            <div class="form-group">
                <div class="stm-lms-admin-checkbox">
                    <label>
                        <h4><?php esc_html_e( 'Join Before Host', 'masterstudy-lms-learning-management-system-pro' ); ?></h4>
                    </label>
            ...
            <div class="form-group">
                <div class="stm-lms-admin-checkbox">
                    <label>
                        <h4><?php esc_html_e( 'Host join start', 'masterstudy-lms-learning-management-system-pro' ); ?></h4>
                    </label>
            ...
            <div class="form-group">
                <div class="stm-lms-admin-checkbox">
                    <label>
                        <h4><?php esc_html_e( 'Start After Participants', 'masterstudy-lms-learning-management-system-pro' ); ?></h4>
                    </label>
            ...
            <div class="form-group">
                <div class="stm-lms-admin-checkbox">
                    <label>
                        <h4><?php esc_html_e( 'Enforce Login', 'masterstudy-lms-learning-management-system-pro' ); ?></h4>
                    </label>
                    <div class="stm-lms-admin-checkbox-wrapper"
    ...
    public static function stream_clear_start_time( $item_id, $start_date = '', $start_time = '' )
    {
        ...
        $stream_start = date('Y-m-d H:i:s', $stream_start);
    ...
    public static function update_meeting( $post_id, $post_data )
    {
        if( $post_data[ 'type' ] === 'zoom_conference' ) {
            ...
            if( !$is_edit ) {
                ...
                else if( !empty( $meeting_updated->code ) && $meeting_updated->code == 1113 ) {
            ...
            if( $lesson_type === 'zoom_conference' ) {
                ...
                if( empty($is_edit) ) {
                    ...
                    if( !empty( $meeting_updated->error ) ) {
                        ...
                        $meeting_data = json_decode( stm_lms_zoom_conference()->getMeetingInfo( $update_meeting_arr[ 'meeting_id' ] ) );
                        $date = new DateTime($update_meeting_arr[ 'start_date' ], new DateTimeZone($update_meeting_arr['timezone']));
                        $time = new \DateTime('now', new DateTimeZone($update_meeting_arr['timezone']));
                        $meeting_time = $date->format('m/d/Y h:i:s a') . ' ' . $time->format('P');
