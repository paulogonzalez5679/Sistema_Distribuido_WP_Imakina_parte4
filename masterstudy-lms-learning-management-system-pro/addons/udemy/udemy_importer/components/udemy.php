<div>
	...
	<div class="stm_lms_udemy_search" v-bind:class="{'loading' : loading}">
		...
		<table v-if="typeof courses != 'string'">
			<thead>
			<tr>
				<th class="course_id"><?php esc_html_e('Course ID', 'masterstudy-lms-learning-management-system'); ?></th>
				<th class="course_title"><?php esc_html_e('Title', 'masterstudy-lms-learning-management-system'); ?></th>
				<th class="stm_lms_actions"><?php esc_html_e('Actions', 'masterstudy-lms-learning-management-system'); ?></th>
			</tr>
			</thead>
			<tbody>
			<tr v-for="(course, key) in courses" v-bind:class="{'loading' : course.lms_publishing}">
				...
				<td class="stm_lms_actions">
					...
					<div v-if="!course.imported"
						...
						<span v-if="!course.loading_text"><?php esc_html_e('Import Course', 'masterstudy-lms-learning-management-system'); ?></span>
					...
					<div v-else class="stm_lms_action__edit">
						...
						<div class="stm_lms_udemy_import_course publish" @click="publish(key, course.id)">
							<span v-if="!course.lms_published"><?php esc_html_e('Publish', 'masterstudy-lms-learning-management-system'); ?></span>
