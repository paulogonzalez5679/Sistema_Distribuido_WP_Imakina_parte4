<div class="stm_lms_edit_socials">
    <div class="row">
        ...
        <div class="col-md-12">
            <h3><?php esc_html_e('Socials', 'masterstudy-lms-learning-management-system'); ?></h3>
    ...
    <div class="stm_lms_edit_socials_list">
        <div class="row">
            ...
            <div class="col-md-6">
                ...
                <div class="form-group">
                    <label class="heading_font"><?php esc_html_e('Whatsapp', 'masterstudy-lms-learning-management-system'); ?></label>
                    <div class="form-group-social">
                        <input v-model="data.meta.whatsapp"
                               class="form-control"
                               placeholder="<?php esc_html_e('Enter your whatsapp URL', 'masterstudy-lms-learning-management-system') ?>"/>
