...
class STM_LMS_User_Manager_User_Quiz
{
    ...
    function student_quizzes()
    {
        ...
        if (empty($data['student_id']) or empty($data['quiz_id'])) die;
    ...
    function student_quiz()
    {
        ...
        <link rel="stylesheet" href="<?php echo esc_url(STM_LMS_URL . '/assets/css/parts/quiz.css') ?>"/>
        <link rel="stylesheet" href="<?php echo esc_url(STM_LMS_URL . '/assets/css/parts/keywords_question.css') ?>"/>
        <link rel="stylesheet" href="<?php echo esc_url(STM_LMS_URL . '/assets/css/parts/item_match_question.css') ?>"/>
        <link rel="stylesheet" href="<?php echo esc_url(STM_LMS_URL . '/assets/css/parts/fill_the_gap.css') ?>"/>

        <?php if ($q->have_posts()) {
        $last_answers = stm_lms_get_quiz_attempt_answers($student_id, $quiz_id, array('question_id', 'user_answer', 'correct_answer'), $attempt);
